...
BEGIN
  IF (TG_OP = 'UPDATE') THEN
    ...
    IF (((OLD.disease_qualifier IS NULL) AND (NEW.disease_qualifier IS NOT NULL)) OR ((OLD.disease_qualifier IS NOT NULL) AND (NEW.disease_qualifier IS NULL)) OR (OLD.disease_qualifier != disease_qualifier)) THEN
